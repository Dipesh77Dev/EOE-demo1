# Desanixr Backend architecture 🛡️

This is the example repository from the blog post ['Desanixr Backend project architecture'](https://softwareontheroad.com/ideal-nodejs-project-structure?utm_source=github&utm_medium=readme)
...
- clone the `desanixrBackendTemplate` repo.
