...
declare global {
  ...
  namespace Models {
    ...
    export type LoginHistoryModel = Model<ILoginHistory & Document>;
    export type VideoUrlModel = Model<IVideoUrl & Document>;
    export type EventDetailModel = Model<IEventDetail & Document>;
  }
}
