...
const SideNavigation = () => {
  ...
  const navigation = [
    ...
    { name: 'Screens', to: './screens', icon: FolderIcon },
    { name: 'Scenes', to: './scenes', icon: FolderIcon },
    { name: 'Images', to: './images', icon: FolderIcon },
...
const Logo = () => {
  return (
    <Link className="flex items-center text-white" to=".">
      ...
      <span className="text-xl text-white font-semibold">DesaniXR-Admin React</span>
    </Link>
  );
};
