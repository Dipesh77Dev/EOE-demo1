...
import { DxrForm, InputField, DxrSelectField } from '@/components/Form';
...
export const RegisterForm = ({ onSuccess }: RegisterFormProps) => {
  ...
  return (
    <div>
      <DxrForm<RegisterValues, typeof schema>
      ...
      >
        {({ register, formState }) => (
          <>
            ...
            <div>
              <DxrButton isLoading={isRegistering} type="submit" className="w-full">
                Register
              </DxrButton>
            </div>
          </>
